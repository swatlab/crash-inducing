...
def outputChangedTypes(all_changed_results):
    ...
    for f in all_changed_results:
        ...
        types_set |= type_set
    #   Combine types and modes (modes: added, deleted, modified)
    ...
    df.to_csv('analytic_code/changed_types.csv', header=True, index=False)
    return
...
if(__name__ == '__main__'):
    ...
    outputChangedTypes(all_changed_results)
